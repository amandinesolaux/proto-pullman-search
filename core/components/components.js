...
(function () {
  ...
  const REGION_HOTELS = [
    { id:'europe', label:'Europe', img:'https://images.unsplash.com/photo-1499856871958-5b9627545d1a?w=200&h=200&fit=crop', hotels: [
      { name:'Pullman Bordeaux Lac', loc:'Bordeaux, France', country:'France', img:'HCM_P_1340478', imgs:['HCM_P_1340478','HCM_P_9115564','aja_p_4919-32','HCM_P_6246722'], href:'https://pullman.accor.com/fr/hotels/bordeaux-le-lac/0669.html', services:['pool','restaurant','bar','parking','meeting-rooms','gym','wifi','breakfast','garden','pets','family'] },
      { name:'Pullman Cannes Mandelieu', loc:'Mandelieu, France', country:'France', img:'1168-1', imgs:['1168-1','aja_p_2612-38','HCM_P_2542733','aja_p_2612-39'], href:'https://pullman.accor.com/fr/hotels/mandelieu-la-napoule/1168.html', services:['pool','restaurant','bar','parking','meeting-rooms','gym','wifi','breakfast','golf','garden','beach','pets','family','kids-club'] },
      ...
      { name:'Pullman Montpellier Centre', loc:'Montpellier, France', country:'France', img:'aja_p_6825-55', imgs:['aja_p_6825-55','aja_p_6756-89','aja_p_6756-36','aja_p_6757-23'], href:'https://pullman.accor.com/fr/hotels/montpellier/1294.html', services:['restaurant','bar','parking','meeting-rooms','gym','wifi','breakfast','pets','family'] },
      { name:'Pullman Paris Centre - Bercy', loc:'Paris, France', country:'France', img:'HCM_P_7730696', imgs:['HCM_P_7730696','aja_p_2868-40','aja_p_5690-66','aja_p_6886-87'], href:'https://pullman.accor.com/fr/hotels/paris/2192.html', services:['restaurant','bar','parking','meeting-rooms','gym','wifi','breakfast','pets','family'] },
      ...
      { name:'Pullman Toulouse Airport', loc:'Toulouse, France', country:'France', img:'HCM_P_9842792', imgs:['HCM_P_9842792','HCM_P_3903765','HCM_P_1909175','HCM_P_0021671'], href:'https://pullman.accor.com/fr/hotels/toulouse/0565.html', services:['restaurant','bar','parking','meeting-rooms','gym','wifi','breakfast','airport-shuttle','pets','family'] },
      { name:'Pullman Berlin Schweizerhof', loc:'Berlin, Allemagne', country:'Allemagne', img:'HCM_P_0024306', imgs:['HCM_P_0024306','aja_p_4345-48','aja_p_4345-36','HCM_P_7434364'], href:'https://pullman.accor.com/fr/hotels/berlin/5347.html', services:['restaurant','bar','spa','parking','meeting-rooms','gym','wifi','breakfast'] },
      ...
      { name:'Pullman Munich', loc:'Munich, Allemagne', country:'Allemagne', img:'HCM_P_5706025', imgs:['HCM_P_5706025','HCM_P_1215376','HCM_P_5147628','HCM_P_6965392'], href:'https://pullman.accor.com/fr/hotels/munich/8657.html', services:['restaurant','bar','parking','meeting-rooms','gym','wifi','breakfast','pets'] },
      ...
      { name:'Pullman Brussels Centre Midi', loc:'Bruxelles, Belgique', country:'Belgique', img:'HCM_P_9624550', imgs:['HCM_P_9624550','HCM_P_9147662','HCM_P_1582844','aja_p_6393-86'], href:'https://pullman.accor.com/fr/hotels/brussels/7431.html', services:['restaurant','bar','parking','meeting-rooms','gym','wifi','breakfast','pets'] },
      { name:'Pullman Bucharest WTC', loc:'Bucarest, Roumanie', country:'Roumanie', img:'HCM_P_6874187', imgs:['HCM_P_6874187','aja_p_4069-32','aja_p_4069-35','HCM_P_5719851'], href:'https://pullman.accor.com/fr/hotels/bucharest/1714.html', services:['restaurant','bar','parking','meeting-rooms','gym','wifi','breakfast','pets'] },
      ...
      { name:'Pullman Eindhoven Cocagne', loc:'Eindhoven, Pays-Bas', country:'Pays-Bas', img:'aja_p_2109-36', imgs:['aja_p_2109-36','aja_p_5152-20','aja_p_2336-09','aja_p_7027-53'], href:'https://pullman.accor.com/fr/hotels/eindhoven/5374.html', services:['restaurant','bar','parking','meeting-rooms','gym','wifi','breakfast','pets'] },
      { name:'Pullman Basel Europe', loc:'Bâle, Suisse', country:'Suisse', img:'aja_p_3176-51', imgs:['aja_p_3176-51','aja_p_4798-51','aja_p_4798-35','aja_p_4798-26'], href:'https://pullman.accor.com/fr/hotels/basel/5921.html', services:['restaurant','bar','parking','meeting-rooms','gym','wifi','breakfast','pets'] },
      { name:'Pullman Liverpool', loc:'Liverpool, Royaume-Uni', country:'Royaume-Uni', img:'aja_p_3897-28', imgs:['aja_p_3897-28','aja_p_3897-26','aja_p_6201-04','aja_p_6201-15'], href:'https://pullman.accor.com/fr/hotels/liverpool/9227.html', services:['restaurant','bar','parking','meeting-rooms','gym','wifi','breakfast'] },
      ...
      { name:'Pullman Riga Old Town', loc:'Riga, Lettonie', country:'Lettonie', img:'HCM_P_1895951', imgs:['HCM_P_1895951','HCM_P_8831152','HCM_P_5387839','HCM_P_9412686'], href:'https://pullman.accor.com/fr/hotels/riga/9619.html', services:['restaurant','bar','parking','meeting-rooms','gym','wifi','breakfast'] },
      { name:'Pullman Tbilisi Axis Towers', loc:'Tbilissi, Géorgie', country:'Géorgie', img:'aja_p_6321-41', imgs:['aja_p_6321-41','aja_p_6271-09','aja_p_6271-12','aja_p_6271-03'], href:'https://pullman.accor.com/fr/hotels/tbilisi/A1F1.html', services:['restaurant','bar','pool','spa','parking','meeting-rooms','gym','wifi','breakfast','pets'] },
      { name:'Pullman Zagreb', loc:'Zagreb, Croatie', country:'Croatie', img:'HCM_P_2775778', imgs:['HCM_P_2775778','HCM_P_5109785','HCM_P_3307072','HCM_P_1289569'], href:'https://pullman.accor.com/fr/hotels/zagreb/C030.html', services:['restaurant','bar','parking','meeting-rooms','gym','wifi','breakfast','pets'] },
      { name:'Pullman Gorni Okol', loc:'Gorni Okol, Bulgarie', country:'Bulgarie', img:'aja_p_6736-09', imgs:['aja_p_6736-09','aja_p_6736-71','aja_p_6737-02','aja_p_6736-24'], href:'https://pullman.accor.com/fr/hotels/gorni-okol/B364.html', services:['restaurant','bar','pool','spa','parking','meeting-rooms','gym','wifi','breakfast','garden','family'] },
    ]},
    { id:'asie', label:'Asie', img:'https://images.unsplash.com/photo-1493780474015-ba834fd0ce2f?w=200&h=200&fit=crop', hotels: [
      ...
      { name:'Pullman Khao Lak Resort', loc:'Phang Nga, Thaïlande', country:'Thaïlande', img:'HCM_P_1554785', imgs:['HCM_P_1554785','HCM_P_8518535','HCM_P_6265718','aja_p_5568-49'], href:'https://pullman.accor.com/fr/hotels/phang-nga/B436.html', services:['pool','restaurant','bar','spa','beach','gym','wifi','breakfast','garden','family','kids-club'] },
      { name:'Pullman Pattaya Hotel G', loc:'Pattaya, Thaïlande', country:'Thaïlande', img:'HCM_P_7523610', imgs:['HCM_P_7523610','HCM_P_7051842','HCM_P_8980556','HCM_P_5187191'], href:'https://pullman.accor.com/fr/hotels/pattaya/7540.html', services:['pool','restaurant','bar','spa','beach','gym','meeting-rooms','wifi','breakfast'] },
      { name:'Pullman Phuket Arcadia', loc:'Phuket, Thaïlande', country:'Thaïlande', img:'aja_p_5366-99', imgs:['aja_p_5366-99','aja_p_3130-32','aja_p_4065-36','HCM_P_2335857'], href:'https://pullman.accor.com/fr/hotels/phuket/7488.html', services:['pool','restaurant','bar','spa','beach','parking','meeting-rooms','gym','wifi','breakfast','airport-shuttle','pets','family','kids-club'] },
      ...
      { name:'Pullman Bandung Grand Central', loc:'Bandung, Indonésie', country:'Indonésie', img:'aja_p_5545-01', imgs:['aja_p_5545-01','aja_p_5545-05','aja_p_5545-04','aja_p_6408-92'], href:'https://pullman.accor.com/fr/hotels/bandung/9109.html', services:['pool','restaurant','bar','spa','parking','meeting-rooms','gym','wifi','breakfast','pets','family','kids-club'] },
      { name:'Pullman Ciawi Vimala Hills', loc:'Bogor, Indonésie', country:'Indonésie', img:'9061-1', imgs:['9061-1','aja_p_5382-19','aja_p_5382-11','aja_p_5382-17'], href:'https://pullman.accor.com/fr/hotels/bogor/9061.html', services:['pool','restaurant','bar','spa','parking','meeting-rooms','gym','wifi','breakfast','garden','golf','family','kids-club'] },
      ...
      { name:'Pullman Vung Tau', loc:'Vung Tau, Vietnam', country:'Vietnam', img:'aja_p_3776-35', imgs:['aja_p_3776-35','HCM_P_3728191','HCM_P_3358492','HCM_P_6591913'], href:'https://pullman.accor.com/fr/hotels/ho-chi-minh/7133.html', services:['pool','restaurant','bar','spa','beach','gym','wifi','breakfast','family'] },
      ...
      { name:'Pullman Chennai Anna Salai', loc:'Chennai, Inde', country:'Inde', img:'HCM_P_4907674', imgs:['HCM_P_4907674','HCM_P_1053974','HCM_P_6692614','HCM_P_8457596'], href:'https://pullman.accor.com/fr/hotels/chennai/C460.html', services:['pool','restaurant','bar','spa','parking','meeting-rooms','gym','wifi','breakfast','pets'] },
    ...
    { id:'moyen-orient', label:'Moyen-Orient', img:'https://images.unsplash.com/photo-1512453979798-5ea266f8880c?w=200&h=200&fit=crop', hotels: [
      { name:'Pullman Dubai Creek City Centre', loc:'Dubaï, EAU', country:'EAU', img:'aja_p_2749-07', imgs:['aja_p_2749-07','aja_p_5151-78','aja_p_5151-79','aja_p_2691-24'], href:'https://pullman.accor.com/fr/hotels/dubai/2022.html', services:['pool','restaurant','bar','spa','parking','meeting-rooms','gym','wifi','breakfast','family','kids-club'] },
    ...
    { id:'oceanie', label:'Océanie', img:'https://images.unsplash.com/photo-1523482580672-f109ba8cb9be?w=200&h=200&fit=crop', hotels: [
      ...
      { name:'Pullman Auckland Airport', loc:'Auckland, Nouvelle-Zélande', country:'Nouvelle-Zélande', img:'HCM_P_4048188', imgs:['HCM_P_4048188','HCM_P_0019724','HCM_P_2721024','aja_p_7078-85'], href:'https://pullman.accor.com/fr/hotels/auckland/A8U9.html', services:['restaurant','bar','parking','meeting-rooms','gym','wifi','breakfast','airport-shuttle','pets','family'] },
    ...
    { id:'ameriques', label:'Amériques', img:'https://images.unsplash.com/photo-1534351590666-13e3e96b5017?w=200&h=200&fit=crop', hotels: [
      { name:'Pullman São Paulo Vila Olímpia', loc:'São Paulo, Brésil', country:'Brésil', img:'HCM_P_2616072', imgs:['HCM_P_2616072','aja_p_4719-10','HCM_P_8104296','HCM_P_3373661'], href:'https://pullman.accor.com/fr/hotels/sao-paulo/8938.html', services:['pool','restaurant','bar','spa','parking','meeting-rooms','gym','wifi','breakfast'] },
    ...
    { id:'afrique', label:'Afrique', img:'https://images.unsplash.com/photo-1547471080-7cc2caa01a7e?w=200&h=200&fit=crop', hotels: [
      { name:'Pullman Mazagan Royal Golf & Spa', loc:'El Jadida, Maroc', country:'Maroc', img:'aja_p_6645-45', imgs:['aja_p_6645-45','aja_p_5066-24','aja_p_6645-49','aja_p_6645-38'], href:'https://pullman.accor.com/fr/hotels/el-jadida/2960.html', services:['pool','restaurant','bar','spa','beach','parking','meeting-rooms','gym','wifi','breakfast','golf','garden','pets','family','kids-club'] },
    ...
    afterRender() {
      ...
      const CRITERIA_GROUPS = {
        ...
        hotels: [
          ...
          { group: 'Séjour', items: [
            { id: 'family', label: 'Adapté aux familles' },
  ...
  def("wd-discovery-modal", class extends WdEl {
    ...
    afterRender() {
      ...
      if (this.state.currentStep === 'agent') {
        ...
        // chargé sur toutes les pages où l'assistant s'ouvre. Une galerie repart de la photo
        // affichée : la card posée sur la carte est une copie de celle du carrousel.
        const lierGalerie = (media) => {
          const photos = [...media.querySelectorAll('.wd-agent__hotel-img')];
          const points = [...media.querySelectorAll('.wd-agent__hotel-point')];
          let courant = Math.max(0, photos.findIndex(im => im.hasAttribute('data-on')));
          const montrer = (i) => {
        ...
        // Carte des hôtels proposés, dans l'habit de la carte de la homepage : fond sombre, pins
        // verts nommés, zoom en haut à droite, et les points d'intérêt de la ville (WD_POI) — un
        // point et un nom par lieu, dans la couleur de sa catégorie. Ouverte, elle prend la place
        // du carrousel : la card de l'hôtel choisi se pose en bas de la carte, comme sur Airbnb —
        // le premier hôtel d'emblée, un autre au clic sur son pin ; cliquer la carte hors d'un pin
        // ou la croix la retire. Refaite à chaque rendu : l'ancienne carte est détruite avec le
        // DOM qu'elle occupait.
        ...
        if (basculeCarte) {
          ...
          // Monuments d'abord, transports en dernier : c'est aussi l'ordre dans lequel les lieux
          // gardent leur place quand ils se chevauchent.
          const RANG = { embleme: 400, musee: 300, spectacle: 300, culte: 300, shopping: 300, parc: 200, gare: 100, aeroport: 100, metro: 0 };
          let pins = [];
          let lieux = [];
          let choisi = -1;

          // Place prise sur la carte, dans l'ordre d'importance, comme chez Airbnb : la card posée
          // sur la carte d'abord — rien ne s'affiche dessous —, puis les hôtels, l'hôtel choisi en
          // tête, qui ne s'effacent jamais, seul leur nom peut céder ; puis les lieux par rang. Un
          // lieu dont le point heurte ce qui est déjà posé disparaît avec son nom et revient en
          // zoomant ; un nom qui heurte s'efface seul et revient au survol.
          const ajusterEtiquettes = () => {
            ...
            if (fiche && !fiche.hidden) poses.push(fiche.getBoundingClientRect());
            pins.slice().sort((a, b) => (b.i === choisi) - (a.i === choisi)).forEach(p => {
          ...
          const marquer = () => {
            pins.forEach(p => {
              const el = p.marqueur.getElement();
              if (el) el.classList.toggle('pullman-map-marker--selected', p.i === choisi);
              p.marqueur.setZIndexOffset(p.i === choisi ? 2000 : 1000);
            });
            ajusterEtiquettes();
          };
          // Hauteur que la card prend au bas de la carte, marge comprise : le cadrage la réserve.
          const reserveFiche = () => (fiche && !fiche.hidden ? fiche.offsetHeight + 24 : 28);
          const cacherFiche = () => {
            choisi = -1;
            if (fiche) { fiche.hidden = true; fiche.innerHTML = ''; }
            marquer();
          };
          // La card de l'hôtel choisi, copiée du carrousel et mise en largeur pour tenir au bas
          // de la carte. Si son pin tombe sous la card, la carte se décale pour le montrer.
          const montrerFiche = (i, recentrer) => {
            ...
            croix.type = 'button';
            croix.className = 'wd-agent__carte-fiche-fermer';
            croix.setAttribute('aria-label', 'Fermer la fiche de l’hôtel');
            croix.addEventListener('click', (e) => { e.stopPropagation(); cacherFiche(); });
            fiche.innerHTML = '';
            fiche.append(copie, croix);
            fiche.hidden = false;
            const media = copie.querySelector('[data-agent-galerie]');
            if (media) lierGalerie(media);
            marquer();
            const carte = this._agentCarteLeaflet;
            const pin = pins.find(p => p.i === i);
            if (recentrer && carte && pin) {
              carte.panInside(pin.marqueur.getLatLng(), { paddingTopLeft: [40, 40], paddingBottomRight: [40, reserveFiche() + 16] });
            }
          };
          ...
          const ouvrir = () => {
            ...
            // Plusieurs hôtels : leur nom sans « Pullman », comme sur la homepage une fois les pins
            // d'une ville séparés. Un seul : son nom entier.
            ...
            pins = cartesSituees.map(c => {
              ...
              marqueur.on('click', () => montrerFiche(i, true));
              return { i, marqueur };
            });
            const poi = [];
            ...
            // Cliquer la carte hors d'un pin retire la card : même geste que sur la homepage.
            carte.on('click', cacherFiche);
            // La première card d'emblée : on voit tout de suite un hôtel, et où il se trouve.
            if (cartesSituees.length) montrerFiche(Number(cartesSituees[0].dataset.agentHotel), false);
            // Cadrage : les hôtels et les lieux à moins de 5 km d'eux, au-dessus de la card.
            // L'aéroport reste sur la carte, mais on ne dézoome pas jusqu'à lui.
            ...
            const bas = reserveFiche();
            if (cadrage.length === 1) {
              carte.setView(cadrage[0], 14, { animate: false });
              carte.panBy([0, bas / 2], { animate: false });
            } else {
              carte.fitBounds(L.latLngBounds(cadrage), { paddingTopLeft: [28, 28], paddingBottomRight: [28, bas], maxZoom: 15, animate: false });
            }
