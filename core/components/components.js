...
(function () {
  ...
  const REGION_HOTELS = [
    { id:'europe', label:'Europe', img:'https://images.unsplash.com/photo-1499856871958-5b9627545d1a?w=200&h=200&fit=crop', hotels: [
      { name:'Pullman Bordeaux Lac', loc:'Bordeaux, France', country:'France', img:'HCM_P_1340478', href:'https://pullman.accor.com/fr/hotels/bordeaux-le-lac/0669.html', services:['pool','restaurant','bar','parking','meeting-rooms','gym','wifi','breakfast','garden','family'] },
      { name:'Pullman Cannes Mandelieu', loc:'Mandelieu, France', country:'France', img:'1168-1', href:'https://pullman.accor.com/fr/hotels/mandelieu-la-napoule/1168.html', services:['pool','restaurant','bar','parking','meeting-rooms','gym','wifi','breakfast','golf','garden','beach','kids-club','family'] },
      { name:'Pullman Lyon', loc:'Lyon, France', country:'France', img:'HCM_P_4125103', href:'https://pullman.accor.com/fr/hotels/lyon/C177.html', services:['restaurant','bar','parking','meeting-rooms','coworking','gym','wifi','breakfast','garden','pets','family'] },
      { name:'Pullman Montpellier Centre', loc:'Montpellier, France', country:'France', img:'aja_p_6825-55', href:'https://pullman.accor.com/fr/hotels/montpellier/1294.html', services:['restaurant','bar','parking','meeting-rooms','gym','wifi','breakfast','family'] },
      { name:'Pullman Paris Centre - Bercy', loc:'Paris, France', country:'France', img:'HCM_P_7730696', href:'https://pullman.accor.com/fr/hotels/paris/2192.html', services:['restaurant','bar','parking','meeting-rooms','gym','wifi','breakfast','family'] },
      { name:'Pullman Paris La Défense', loc:'Paris La Défense, France', country:'France', img:'HCM_P_4713972', href:'https://pullman.accor.com/fr/hotels/paris/3013.html', services:['restaurant','bar','parking','meeting-rooms','coworking','gym','wifi','breakfast','pets','family'] },
      { name:'Pullman Paris Tour Eiffel', loc:'Paris, France', country:'France', img:'HCM_P_6302978', href:'https://pullman.accor.com/fr/hotels/paris/7229.html', services:['restaurant','bar','parking','meeting-rooms','gym','wifi','breakfast','garden'] },
      { name:'Pullman Paris Montparnasse', loc:'Paris, France', country:'France', img:'HCM_P_1448143', href:'https://pullman.accor.com/fr/hotels/paris/8189.html', services:['restaurant','bar','rooftop','parking','meeting-rooms','gym','wifi','breakfast','pets','family'] },
      { name:'Pullman Toulouse Airport', loc:'Toulouse, France', country:'France', img:'HCM_P_9842792', href:'https://pullman.accor.com/fr/hotels/toulouse/0565.html', services:['restaurant','bar','parking','meeting-rooms','gym','wifi','breakfast','airport-shuttle','family'] },
      { name:'Pullman Berlin Schweizerhof', loc:'Berlin, Allemagne', country:'Allemagne', img:'HCM_P_0024306', href:'https://pullman.accor.com/fr/hotels/berlin/5347.html', services:['restaurant','bar','spa','parking','meeting-rooms','gym','wifi','breakfast','pets'] },
      { name:'Pullman Cologne', loc:'Cologne, Allemagne', country:'Allemagne', img:'aja_p_4777-23', href:'https://pullman.accor.com/fr/hotels/koeln/5366.html', services:['restaurant','bar','parking','meeting-rooms','gym','wifi','breakfast'] },
      { name:'Pullman Munich', loc:'Munich, Allemagne', country:'Allemagne', img:'HCM_P_5706025', href:'https://pullman.accor.com/fr/hotels/munich/8657.html', services:['restaurant','bar','parking','meeting-rooms','gym','wifi','breakfast'] },
      { name:'Pullman Stuttgart Fontana', loc:'Stuttgart, Allemagne', country:'Allemagne', img:'aja_p_6902-04', href:'https://pullman.accor.com/fr/hotels/stuttgart/5425.html', services:['restaurant','bar','pool','parking','meeting-rooms','gym','wifi','breakfast','garden','pets'] },
      { name:'Pullman Brussels Centre Midi', loc:'Bruxelles, Belgique', country:'Belgique', img:'HCM_P_9624550', href:'https://pullman.accor.com/fr/hotels/brussels/7431.html', services:['restaurant','bar','parking','meeting-rooms','gym','wifi','breakfast','family'] },
      { name:'Pullman Bucharest WTC', loc:'Bucarest, Roumanie', country:'Roumanie', img:'HCM_P_6874187', href:'https://pullman.accor.com/fr/hotels/bucharest/1714.html', services:['restaurant','bar','parking','meeting-rooms','gym','wifi','breakfast'] },
      { name:'Pullman Budapest', loc:'Budapest, Hongrie', country:'Hongrie', img:'HCM_P_5545881', href:'https://pullman.accor.com/fr/hotels/budapest/C319.html', services:['restaurant','bar','rooftop','parking','meeting-rooms','gym','wifi','breakfast','pets'] },
      { name:'Pullman Eindhoven Cocagne', loc:'Eindhoven, Pays-Bas', country:'Pays-Bas', img:'aja_p_2109-36', href:'https://pullman.accor.com/fr/hotels/eindhoven/5374.html', services:['restaurant','bar','parking','meeting-rooms','gym','wifi','breakfast','family'] },
      { name:'Pullman Basel Europe', loc:'Bâle, Suisse', country:'Suisse', img:'aja_p_3176-51', href:'https://pullman.accor.com/fr/hotels/basel/5921.html', services:['restaurant','bar','parking','meeting-rooms','gym','wifi','breakfast'] },
      { name:'Pullman Liverpool', loc:'Liverpool, Royaume-Uni', country:'Royaume-Uni', img:'aja_p_3897-28', href:'https://pullman.accor.com/fr/hotels/liverpool/9227.html', services:['restaurant','bar','parking','meeting-rooms','gym','wifi','breakfast','pets'] },
      { name:'Pullman London St Pancras', loc:'Londres, Royaume-Uni', country:'Royaume-Uni', img:'aja_p_5227-26', href:'https://pullman.accor.com/fr/hotels/london/5309.html', services:['restaurant','bar','meeting-rooms','gym','wifi','breakfast','family'] },
      { name:'Pullman Istanbul', loc:'Istanbul, Turquie', country:'Turquie', img:'aja_p_3849-06', href:'https://pullman.accor.com/fr/hotels/istanbul/9429.html', services:['restaurant','bar','pool','spa','parking','meeting-rooms','gym','wifi','breakfast'] },
      { name:'Pullman Riga Old Town', loc:'Riga, Lettonie', country:'Lettonie', img:'HCM_P_1895951', href:'https://pullman.accor.com/fr/hotels/riga/9619.html', services:['restaurant','bar','parking','meeting-rooms','gym','wifi','breakfast','pets'] },
      { name:'Pullman Tbilisi Axis Towers', loc:'Tbilissi, Géorgie', country:'Géorgie', img:'aja_p_6321-41', href:'https://pullman.accor.com/fr/hotels/tbilisi/A1F1.html', services:['restaurant','bar','pool','spa','parking','meeting-rooms','gym','wifi','breakfast'] },
      { name:'Pullman Zagreb', loc:'Zagreb, Croatie', country:'Croatie', img:'HCM_P_2775778', href:'https://pullman.accor.com/fr/hotels/zagreb/C030.html', services:['restaurant','bar','parking','meeting-rooms','gym','wifi','breakfast'] },
      { name:'Pullman Gorni Okol', loc:'Gorni Okol, Bulgarie', country:'Bulgarie', img:'aja_p_6736-09', href:'https://pullman.accor.com/fr/hotels/gorni-okol/B364.html', services:['restaurant','bar','pool','spa','parking','meeting-rooms','gym','wifi','breakfast','garden','pets','family'] },
    ]},
    { id:'asie', label:'Asie', img:'https://images.unsplash.com/photo-1493780474015-ba834fd0ce2f?w=200&h=200&fit=crop', hotels: [
      { name:'Pullman Bangkok Hotel G', loc:'Bangkok, Thaïlande', country:'Thaïlande', img:'aja_p_4648-59', href:'https://pullman.accor.com/fr/hotels/bangkok/3616.html', badge:'RÉNOVÉ', services:['pool','restaurant','bar','spa','gym','meeting-rooms','wifi','breakfast'] },
      { name:'Pullman Bangkok King Power', loc:'Bangkok, Thaïlande', country:'Thaïlande', img:'HCM_P_0021714', href:'https://pullman.accor.com/fr/hotels/bangkok/6323.html', services:['pool','restaurant','bar','spa','parking','meeting-rooms','gym','wifi','breakfast'] },
      { name:'Pullman Khon Kaen Raja Orchid', loc:'Khon Kaen, Thaïlande', country:'Thaïlande', img:'aja_p_3572-02', href:'https://pullman.accor.com/fr/hotels/khon-kaen/1877.html', services:['pool','restaurant','bar','spa','parking','meeting-rooms','gym','wifi','breakfast','pets'] },
      { name:'Pullman Khao Lak Resort', loc:'Phang Nga, Thaïlande', country:'Thaïlande', img:'HCM_P_1554785', href:'https://pullman.accor.com/fr/hotels/phang-nga/B436.html', services:['pool','restaurant','bar','spa','beach','kids-club','gym','wifi','breakfast','garden','family'] },
      { name:'Pullman Pattaya Hotel G', loc:'Pattaya, Thaïlande', country:'Thaïlande', img:'HCM_P_7523610', href:'https://pullman.accor.com/fr/hotels/pattaya/7540.html', services:['pool','restaurant','bar','spa','beach','gym','meeting-rooms','wifi','breakfast','family'] },
      { name:'Pullman Phuket Arcadia', loc:'Phuket, Thaïlande', country:'Thaïlande', img:'aja_p_5366-99', href:'https://pullman.accor.com/fr/hotels/phuket/7488.html', services:['pool','restaurant','bar','spa','beach','kids-club','parking','meeting-rooms','gym','wifi','breakfast','airport-shuttle','pets','family'] },
      { name:'Pullman Phuket Panwa Beach', loc:'Phuket, Thaïlande', country:'Thaïlande', img:'aja_p_5468-90', href:'https://pullman.accor.com/fr/hotels/phuket/A2E5.html', services:['pool','restaurant','bar','spa','beach','gym','wifi','breakfast','garden','family'] },
      { name:'Pullman Bali Legian Beach', loc:'Bali, Indonésie', country:'Indonésie', img:'HCM_P_7887571', href:'https://pullman.accor.com/fr/hotels/legian/6556.html', services:['pool','restaurant','bar','spa','beach','gym','meeting-rooms','wifi','breakfast','family'] },
      { name:'Pullman Bandung Grand Central', loc:'Bandung, Indonésie', country:'Indonésie', img:'aja_p_5545-01', href:'https://pullman.accor.com/fr/hotels/bandung/9109.html', services:['pool','restaurant','bar','spa','parking','meeting-rooms','gym','wifi','breakfast','pets','kids-club','family'] },
      { name:'Pullman Ciawi Vimala Hills', loc:'Bogor, Indonésie', country:'Indonésie', img:'9061-1', href:'https://pullman.accor.com/fr/hotels/bogor/9061.html', services:['pool','restaurant','bar','spa','parking','meeting-rooms','gym','wifi','breakfast','garden','golf','kids-club','family'] },
      { name:'Pullman Jakarta Central Park', loc:'Jakarta, Indonésie', country:'Indonésie', img:'aja_p_6625-02', href:'https://pullman.accor.com/fr/hotels/jakarta/7536.html', services:['pool','restaurant','bar','spa','parking','meeting-rooms','gym','wifi','breakfast'] },
      { name:'Pullman Jakarta Indonesia', loc:'Jakarta, Indonésie', country:'Indonésie', img:'aja_p_4809-09', href:'https://pullman.accor.com/fr/hotels/jakarta/8491.html', services:['pool','restaurant','bar','spa','parking','meeting-rooms','gym','wifi','breakfast','pets'] },
      { name:'Pullman Lombok Merujani', loc:'Lombok, Indonésie', country:'Indonésie', img:'aja_p_6419-71', href:'https://pullman.accor.com/fr/hotels/central-lombok/A1K2.html', services:['pool','restaurant','bar','spa','beach','gym','wifi','breakfast','garden'] },
      { name:'Pullman Danang Beach Resort', loc:'Danang, Vietnam', country:'Vietnam', img:'HCM_P_6539226', href:'https://pullman.accor.com/fr/hotels/danang/8838.html', services:['pool','restaurant','bar','spa','beach','gym','meeting-rooms','wifi','breakfast','family'] },
      { name:'Pullman Hai Phong', loc:'Hai Phong, Vietnam', country:'Vietnam', img:'HCM_P_3916085', href:'https://pullman.accor.com/fr/hotels/hai-phong/B4S6.html', services:['pool','restaurant','bar','spa','parking','meeting-rooms','gym','wifi','breakfast','pets'] },
      { name:'Pullman Hanoi', loc:'Hanoï, Vietnam', country:'Vietnam', img:'aja_p_4458-36', href:'https://pullman.accor.com/fr/hotels/hanoi/7579.html', services:['pool','restaurant','bar','spa','parking','meeting-rooms','gym','wifi','breakfast'] },
      { name:'Pullman Saigon Centre', loc:'Hô Chi Minh-Ville, Vietnam', country:'Vietnam', img:'HCM_P_1916388', href:'https://pullman.accor.com/fr/hotels/ho-chi-minh/7489.html', services:['pool','restaurant','bar','spa','parking','meeting-rooms','gym','wifi','breakfast','rooftop'] },
      { name:'Pullman Phu Quoc Beach Resort', loc:'Phu Quoc, Vietnam', country:'Vietnam', img:'aja_p_5547-83', href:'https://pullman.accor.com/fr/hotels/phu-quoc/A248.html', services:['pool','restaurant','bar','spa','beach','gym','wifi','breakfast','garden','pets'] },
      { name:'Pullman Vung Tau', loc:'Vung Tau, Vietnam', country:'Vietnam', img:'aja_p_3776-35', href:'https://pullman.accor.com/fr/hotels/ho-chi-minh/7133.html', services:['pool','restaurant','bar','spa','beach','gym','wifi','breakfast'] },
      { name:'Pullman Beijing South', loc:'Pékin, Chine', country:'Chine', img:'HCM_P_2636398', href:'https://pullman.accor.com/fr/hotels/beijing/7025.html', services:['pool','restaurant','bar','spa','parking','meeting-rooms','gym','wifi','breakfast'] },
      { name:'Pullman Lijiang Resort & Spa', loc:'Lijiang, Chine', country:'Chine', img:'aja_p_2311-18', href:'https://pullman.accor.com/fr/hotels/lijiang/7231.html', services:['pool','restaurant','bar','spa','parking','gym','wifi','breakfast','garden','pets'] },
      { name:'Pullman Oceanview Sanya Bay', loc:'Sanya, Chine', country:'Chine', img:'7126-1', href:'https://pullman.accor.com/fr/hotels/sanya/7126.html', services:['pool','restaurant','bar','spa','beach','parking','gym','wifi','breakfast','family'] },
      { name:'Pullman Shanghai Jing\'an', loc:'Shanghai, Chine', country:'Chine', img:'HCM_P_5664798', href:'https://pullman.accor.com/fr/hotels/shanghai/7598.html', services:['restaurant','bar','spa','parking','meeting-rooms','gym','wifi','breakfast'] },
      { name:'Pullman Shanghai Central', loc:'Shanghai, Chine', country:'Chine', img:'met_p_a059-67', href:'https://pullman.accor.com/fr/hotels/shanghai/7298.html', services:['pool','restaurant','bar','spa','parking','meeting-rooms','gym','wifi','breakfast','pets'] },
      { name:'Pullman Guangzhou Baiyun Airport', loc:'Guangzhou, Chine', country:'Chine', img:'aja_p_3825-02', href:'https://pullman.accor.com/fr/hotels/guangzhou/B2W3.html', services:['restaurant','bar','parking','meeting-rooms','gym','wifi','breakfast','airport-shuttle','family'] },
      { name:'Pullman Zhangjiajie', loc:'Zhangjiajie, Chine', country:'Chine', img:'HCM_P_1160915', href:'https://pullman.accor.com/fr/hotels/zhangjiajie/7934.html', services:['pool','restaurant','bar','spa','parking','gym','wifi','breakfast','garden'] },
      { name:'Pullman Guiyang', loc:'Guiyang, Chine', country:'Chine', img:'aja_p_2780-48', href:'https://pullman.accor.com/fr/hotels/guiyang/8275.html', services:['pool','restaurant','bar','spa','parking','meeting-rooms','gym','wifi','breakfast','pets'] },
      { name:'Pullman Dali', loc:'Dali, Chine', country:'Chine', img:'aja_p_6146-38', href:'https://pullman.accor.com/fr/hotels/dali/8627.html', services:['pool','restaurant','bar','spa','parking','gym','wifi','breakfast','garden'] },
      { name:'Pullman New Delhi Aerocity', loc:'New Delhi, Inde', country:'Inde', img:'aja_p_6506-12', href:'https://pullman.accor.com/fr/hotels/new-delhi/7559.html', services:['pool','restaurant','bar','spa','parking','meeting-rooms','gym','wifi','breakfast','airport-shuttle'] },
      { name:'Pullman Chennai Anna Salai', loc:'Chennai, Inde', country:'Inde', img:'HCM_P_4907674', href:'https://pullman.accor.com/fr/hotels/chennai/C460.html', services:['pool','restaurant','bar','spa','parking','meeting-rooms','gym','wifi','breakfast','pets','family'] },
      { name:'Pullman Kuala Lumpur City Centre', loc:'Kuala Lumpur, Malaisie', country:'Malaisie', img:'aja_p_4439-60', href:'https://pullman.accor.com/fr/hotels/kuala-lumpur/A0C5.html', services:['pool','restaurant','bar','spa','parking','meeting-rooms','gym','wifi','breakfast'] },
      { name:'Pullman Kuching', loc:'Kuching, Malaisie', country:'Malaisie', img:'HCM_P_7588157', href:'https://pullman.accor.com/fr/hotels/kuching-sarawak/6332.html', services:['pool','restaurant','bar','spa','parking','meeting-rooms','gym','wifi','breakfast','family'] },
      { name:'Pullman Miri Waterfront', loc:'Miri, Malaisie', country:'Malaisie', img:'aja_p_3964-04', href:'https://pullman.accor.com/fr/hotels/miri/9731.html', services:['pool','restaurant','bar','parking','meeting-rooms','gym','wifi','breakfast','pets'] },
      { name:'Pullman Singapore Hill Street', loc:'Singapour', country:'Singapour', img:'HCM_P_0020377', href:'https://pullman.accor.com/fr/hotels/singapore/B5L7.html', services:['restaurant','bar','gym','meeting-rooms','wifi','breakfast'] },
      { name:'Pullman Singapore Orchard', loc:'Singapour', country:'Singapour', img:'aja_p_6600-45', href:'https://pullman.accor.com/fr/hotels/singapore/B9H8.html', services:['pool','restaurant','bar','spa','gym','meeting-rooms','wifi','breakfast','rooftop','family'] },
      { name:'Pullman Maldives Maamutaa', loc:'Maldives', country:'Maldives', img:'aja_p_5241-71', href:'https://pullman.accor.com/fr/hotels/maamutaa-island/9924.html', badge:'NOUVEAU', services:['pool','restaurant','bar','spa','beach','gym','wifi','breakfast','garden','pets'] },
      { name:'Pullman Luang Prabang', loc:'Luang Prabang, Laos', country:'Laos', img:'aja_p_4935-28', href:'https://pullman.accor.com/fr/hotels/luang-prabang/9112.html', services:['pool','restaurant','bar','spa','gym','wifi','breakfast','garden','kids-club','family'] },
      { name:'Pullman Seoul', loc:'Séoul, Corée du Sud', country:'Corée du Sud', img:'aja_p_6049-58', href:'https://pullman.accor.com/fr/hotels/seoul/0966.html', services:['restaurant','bar','spa','parking','meeting-rooms','gym','wifi','breakfast','family'] },
      { name:'Pullman Tokyo Tamachi', loc:'Tokyo, Japon', country:'Japon', img:'aja_p_6187-84', href:'https://pullman.accor.com/fr/hotels/tokyo/B137.html', services:['restaurant','bar','gym','meeting-rooms','wifi','breakfast','pets'] },
    ]},
    { id:'moyen-orient', label:'Moyen-Orient', img:'https://images.unsplash.com/photo-1512453979798-5ea266f8880c?w=200&h=200&fit=crop', hotels: [
      { name:'Pullman Dubai Creek City Centre', loc:'Dubaï, EAU', country:'EAU', img:'aja_p_2749-07', href:'https://pullman.accor.com/fr/hotels/dubai/2022.html', services:['pool','restaurant','bar','spa','parking','meeting-rooms','gym','wifi','breakfast','family'] },
      { name:'Pullman Dubai Downtown', loc:'Dubaï, EAU', country:'EAU', img:'aja_p_6634-93', href:'https://pullman.accor.com/fr/hotels/dubai/B8D7.html', services:['pool','restaurant','bar','rooftop','spa','parking','meeting-rooms','coworking','gym','wifi','breakfast','airport-shuttle'] },
      { name:'Pullman Dubai JLT', loc:'Dubaï, EAU', country:'EAU', img:'HCM_P_8176030', href:'https://pullman.accor.com/fr/hotels/dubai/6305.html', services:['pool','restaurant','bar','spa','parking','meeting-rooms','gym','wifi','breakfast','pets'] },
      { name:'Pullman Resort Al Marjan Island', loc:'Ras Al Khaimah, EAU', country:'EAU', img:'HCM_P_5994204', href:'https://pullman.accor.com/fr/hotels/ras-al-khaimah/A0D2.html', services:['pool','restaurant','bar','spa','beach','parking','meeting-rooms','gym','wifi','breakfast','garden','family'] },
      { name:'Pullman Sharjah', loc:'Sharjah, EAU', country:'EAU', img:'aja_p_6247-02', href:'https://pullman.accor.com/fr/hotels/sharjah/A0R4.html', services:['pool','restaurant','bar','spa','parking','meeting-rooms','gym','wifi','breakfast'] },
      { name:'Pullman Doha West Bay', loc:'Doha, Qatar', country:'Qatar', img:'HCM_P_7456281', href:'https://pullman.accor.com/fr/hotels/doha/8112.html', services:['pool','restaurant','bar','spa','parking','meeting-rooms','gym','wifi','breakfast','pets'] },
      { name:'Pullman ZamZam Makkah', loc:'La Mecque, Arabie Saoudite', country:'Arabie Saoudite', img:'HCM_P_0015943', href:'https://pullman.accor.com/fr/hotels/makkah/6036.html', services:['restaurant','bar','parking','meeting-rooms','wifi','breakfast'] },
      { name:'Pullman ZamZam Madinah', loc:'Médine, Arabie Saoudite', country:'Arabie Saoudite', img:'aja_p_3895-55', href:'https://pullman.accor.com/fr/hotels/al-madinah-al-munawarah/9245.html', services:['restaurant','bar','parking','meeting-rooms','wifi','breakfast','family'] },
    ]},
    { id:'oceanie', label:'Océanie', img:'https://images.unsplash.com/photo-1523482580672-f109ba8cb9be?w=200&h=200&fit=crop', hotels: [
      { name:'Pullman Adelaide', loc:'Adélaïde, Australie', country:'Australie', img:'aja_p_5134-80', href:'https://pullman.accor.com/fr/hotels/adelaide/B217.html', services:['restaurant','bar','parking','meeting-rooms','gym','wifi','breakfast','pets'] },
      { name:'Pullman Sydney Hyde Park', loc:'Sydney, Australie', country:'Australie', img:'HCM_P_0028770-99', href:'https://pullman.accor.com/fr/hotels/sydney/8763.html', services:['restaurant','bar','parking','meeting-rooms','gym','wifi','breakfast','family'] },
      { name:'Pullman Quay Grand Sydney Harbour', loc:'Sydney, Australie', country:'Australie', img:'aja_p_5512-89', href:'https://pullman.accor.com/fr/hotels/sydney/8779.html', services:['restaurant','bar','pool','parking','gym','wifi','breakfast','garden'] },
      { name:'Pullman Sydney Airport', loc:'Sydney, Australie', country:'Australie', img:'aja_p_4651-21', href:'https://pullman.accor.com/fr/hotels/sydney/9522.html', services:['restaurant','bar','parking','meeting-rooms','gym','wifi','breakfast','airport-shuttle','pets','family'] },
      { name:'Pullman Sydney Olympic Park', loc:'Sydney, Australie', country:'Australie', img:'HCM_P_4720280', href:'https://pullman.accor.com/fr/hotels/sydney/6411.html', services:['restaurant','bar','pool','parking','meeting-rooms','gym','wifi','breakfast'] },
      { name:'Pullman Sydney Penrith', loc:'Sydney, Australie', country:'Australie', img:'HCM_P_9901521', href:'https://pullman.accor.com/fr/hotels/sydney/C0F1.html', services:['restaurant','bar','pool','parking','meeting-rooms','gym','wifi','breakfast','golf','garden'] },
      { name:'Pullman Brisbane King George Sq.', loc:'Brisbane, Australie', country:'Australie', img:'HCM_P_0028771-68', href:'https://pullman.accor.com/fr/hotels/brisbane/8784.html', services:['restaurant','bar','pool','parking','meeting-rooms','gym','wifi','breakfast','pets','family'] },
      { name:'Pullman Brisbane Airport', loc:'Brisbane, Australie', country:'Australie', img:'aja_p_4486-76', href:'https://pullman.accor.com/fr/hotels/brisbane/9559.html', services:['restaurant','bar','pool','parking','meeting-rooms','gym','wifi','breakfast','airport-shuttle'] },
      { name:'Pullman Cairns International', loc:'Cairns, Australie', country:'Australie', img:'aja_p_6031-68', href:'https://pullman.accor.com/fr/hotels/cairns/8772.html', services:['restaurant','bar','pool','parking','meeting-rooms','gym','wifi','breakfast'] },
      { name:'Pullman Reef Hotel Casino', loc:'Cairns, Australie', country:'Australie', img:'HCM_P_8302451', href:'https://pullman.accor.com/fr/hotels/cairns/2901.html', services:['restaurant','bar','pool','parking','meeting-rooms','gym','wifi','breakfast','casino','pets'] },
      { name:'Pullman Bunker Bay Resort', loc:'Margaret River, Australie', country:'Australie', img:'HCM_P_8807216', href:'https://pullman.accor.com/fr/hotels/naturaliste/8775.html', services:['pool','restaurant','bar','spa','beach','parking','gym','wifi','breakfast','garden'] },
      { name:'Pullman Melbourne City Centre', loc:'Melbourne, Australie', country:'Australie', img:'aja_p_5163-76', href:'https://pullman.accor.com/fr/hotels/melbourne/3028.html', services:['restaurant','bar','pool','parking','meeting-rooms','gym','wifi','breakfast'] },
      { name:'Pullman Melbourne Albert Park', loc:'Melbourne, Australie', country:'Australie', img:'HCM_P_0028769-2', href:'https://pullman.accor.com/fr/hotels/melbourne/8788.html', services:['restaurant','bar','pool','parking','meeting-rooms','gym','wifi','breakfast','garden','pets','family'] },
      { name:'Pullman Magenta Shores Resort', loc:'Magenta, Australie', country:'Australie', img:'HCM_P_0018068', href:'https://pullman.accor.com/fr/hotels/magenta/8791.html', services:['pool','restaurant','bar','spa','beach','parking','gym','wifi','breakfast','golf','garden'] },
      { name:'Pullman Palm Cove Sea Temple', loc:'Palm Cove, Australie', country:'Australie', img:'HCM_P_4660559', href:'https://pullman.accor.com/fr/hotels/palm-cove/8761.html', services:['pool','restaurant','bar','spa','beach','gym','wifi','breakfast','garden'] },
      { name:'Pullman Port Douglas Sea Temple', loc:'Port Douglas, Australie', country:'Australie', img:'HCM_P_7592048', href:'https://pullman.accor.com/fr/hotels/port-douglas/8762.html', services:['pool','restaurant','bar','spa','beach','gym','wifi','breakfast','garden','pets'] },
      { name:'Pullman Sails in the Desert', loc:'Ayers Rock, Australie', country:'Australie', img:'aja_p_2376-55', href:'https://pullman.accor.com/fr/hotels/yulara/8606.html', services:['pool','restaurant','bar','parking','gym','wifi','breakfast','garden','family'] },
      { name:'Pullman Auckland Hotel & Apts', loc:'Auckland, Nouvelle-Zélande', country:'Nouvelle-Zélande', img:'aja_p_6787-95', href:'https://pullman.accor.com/fr/hotels/auckland/8219.html', services:['restaurant','bar','pool','parking','meeting-rooms','gym','wifi','breakfast'] },
      { name:'Pullman Auckland Airport', loc:'Auckland, Nouvelle-Zélande', country:'Nouvelle-Zélande', img:'HCM_P_4048188', href:'https://pullman.accor.com/fr/hotels/auckland/A8U9.html', services:['restaurant','bar','parking','meeting-rooms','gym','wifi','breakfast','airport-shuttle','pets'] },
      { name:'Pullman Rotorua', loc:'Rotorua, Nouvelle-Zélande', country:'Nouvelle-Zélande', img:'aja_p_5336-56', href:'https://pullman.accor.com/fr/hotels/rotorua/A7W3.html', services:['restaurant','bar','pool','spa','parking','gym','wifi','breakfast','garden'] },
    ]},
    { id:'ameriques', label:'Amériques', img:'https://images.unsplash.com/photo-1534351590666-13e3e96b5017?w=200&h=200&fit=crop', hotels: [
      { name:'Pullman São Paulo Vila Olímpia', loc:'São Paulo, Brésil', country:'Brésil', img:'HCM_P_2616072', href:'https://pullman.accor.com/fr/hotels/sao-paulo/8938.html', services:['pool','restaurant','bar','spa','parking','meeting-rooms','gym','wifi','breakfast','family'] },
      { name:'Pullman São Paulo Ibirapuera', loc:'São Paulo, Brésil', country:'Brésil', img:'aja_p_4277-55', href:'https://pullman.accor.com/fr/hotels/sao-paulo/2125.html', services:['pool','restaurant','bar','spa','parking','meeting-rooms','gym','wifi','breakfast','pets'] },
      { name:'Pullman São Paulo Guarulhos Airport', loc:'Guarulhos, Brésil', country:'Brésil', img:'HCM_P_8881295', href:'https://pullman.accor.com/fr/hotels/sao-paulo/8923.html', services:['pool','restaurant','bar','parking','meeting-rooms','gym','wifi','breakfast','airport-shuttle','family'] },
      { name:'Pullman Lima Miraflores', loc:'Lima, Pérou', country:'Pérou', img:'aja_p_6055-47', href:'https://pullman.accor.com/fr/hotels/lima/B464.html', services:['pool','restaurant','bar','spa','parking','meeting-rooms','gym','wifi','breakfast'] },
      { name:'Pullman Lima San Isidro', loc:'Lima, Pérou', country:'Pérou', img:'aja_p_6206-02', href:'https://pullman.accor.com/fr/hotels/lima/B462.html', services:['pool','restaurant','bar','spa','parking','meeting-rooms','gym','wifi','breakfast','pets'] },
      { name:'Pullman Santiago El Bosque', loc:'Santiago, Chili', country:'Chili', img:'aja_p_6389-64', href:'https://pullman.accor.com/fr/hotels/santiago/B461.html', services:['pool','restaurant','bar','spa','parking','meeting-rooms','gym','wifi','breakfast'] },
      { name:'Pullman Santiago Vitacura', loc:'Santiago, Chili', country:'Chili', img:'aja_p_6341-93', href:'https://pullman.accor.com/fr/hotels/santiago/B470.html', services:['pool','restaurant','bar','spa','parking','meeting-rooms','gym','wifi','breakfast'] },
      { name:'Pullman Viña del Mar', loc:'Viña del Mar, Chili', country:'Chili', img:'aja_p_5134-84', href:'https://pullman.accor.com/fr/hotels/vina-del-mar/B463.html', services:['pool','restaurant','bar','spa','beach','parking','meeting-rooms','gym','wifi','breakfast','pets'] },
      { name:'Pullman Miami Airport', loc:'Miami, États-Unis', country:'États-Unis', img:'aja_p_4248-17', href:'https://pullman.accor.com/fr/hotels/miami/0889.html', services:['pool','restaurant','bar','parking','meeting-rooms','gym','wifi','breakfast','airport-shuttle','family'] },
      { name:'Pullman Rosario City Center', loc:'Rosario, Argentine', country:'Argentine', img:'aja_p_1934-18', href:'https://pullman.accor.com/fr/hotels/rosario/6784.html', services:['pool','restaurant','bar','spa','parking','meeting-rooms','gym','wifi','breakfast'] },
    ]},
    { id:'afrique', label:'Afrique', img:'https://images.unsplash.com/photo-1547471080-7cc2caa01a7e?w=200&h=200&fit=crop', hotels: [
      ...
      { name:'Pullman Mazagan Royal Golf & Spa', loc:'El Jadida, Maroc', country:'Maroc', img:'aja_p_6645-45', href:'https://pullman.accor.com/fr/hotels/el-jadida/2960.html', services:['pool','restaurant','bar','spa','beach','parking','meeting-rooms','gym','wifi','breakfast','golf','garden','family'] },
      { name:'Pullman Abidjan', loc:'Abidjan, Côte d\'Ivoire', country:'Côte d\'Ivoire', img:'HCM_P_9207481', href:'https://pullman.accor.com/fr/hotels/abidjan/1146.html', services:['pool','restaurant','bar','parking','meeting-rooms','gym','wifi','breakfast'] },
      { name:'Pullman Cape Town', loc:'Le Cap, Afrique du Sud', country:'Afrique du Sud', img:'HCM_P_1079779', href:'https://pullman.accor.com/fr/hotels/cape-town/C0H1.html', services:['pool','restaurant','bar','spa','parking','meeting-rooms','gym','wifi','breakfast','pets'] },
      { name:'Pullman Dakar Teranga', loc:'Dakar, Sénégal', country:'Sénégal', img:'aja_p_4585-30', href:'https://pullman.accor.com/fr/hotels/dakar/0563.html', services:['pool','restaurant','bar','parking','meeting-rooms','gym','wifi','breakfast'] },
      { name:'Pullman Kinshasa Grand Hôtel', loc:'Kinshasa, RD Congo', country:'RD Congo', img:'HCM_P_8092766', href:'https://pullman.accor.com/fr/hotels/kinshasa/9635.html', services:['pool','restaurant','bar','parking','meeting-rooms','gym','wifi','breakfast'] },
      { name:'Pullman Lubumbashi Grand Karavia', loc:'Lubumbashi, RD Congo', country:'RD Congo', img:'HCM_P_8522877', href:'https://pullman.accor.com/fr/hotels/lubumbashi/A0T4.html', services:['pool','restaurant','bar','parking','meeting-rooms','gym','wifi','breakfast','garden','pets'] },
      { name:'Pullman Nairobi Upper Hill', loc:'Nairobi, Kenya', country:'Kenya', img:'HCM_P_2981785', href:'https://pullman.accor.com/fr/hotels/nairobi/C0D4.html', services:['pool','restaurant','bar','parking','meeting-rooms','gym','wifi','breakfast'] },
    ]},
  ];
