...
(function () {
  ...
  const REGION_HOTELS = [
    { id:'europe', label:'Europe', img:'https://images.unsplash.com/photo-1499856871958-5b9627545d1a?w=200&h=200&fit=crop', hotels: [
      { name:'Pullman Bordeaux Lac', loc:'Bordeaux, France', country:'France', img:'HCM_P_1340478', href:'https://pullman.accor.com/fr/hotels/bordeaux-le-lac/0669.html', services:['pool','restaurant','bar','parking','meeting-rooms','gym','wifi','breakfast','garden'] },
      { name:'Pullman Cannes Mandelieu', loc:'Mandelieu, France', country:'France', img:'1168-1', href:'https://pullman.accor.com/fr/hotels/mandelieu-la-napoule/1168.html', services:['pool','restaurant','bar','parking','meeting-rooms','gym','wifi','breakfast','golf','garden','beach'] },
      { name:'Pullman Lyon', loc:'Lyon, France', country:'France', img:'HCM_P_4125103', href:'https://pullman.accor.com/fr/hotels/lyon/C177.html', services:['restaurant','bar','parking','meeting-rooms','coworking','gym','wifi','breakfast','garden','pets'] },
      { name:'Pullman Montpellier Centre', loc:'Montpellier, France', country:'France', img:'aja_p_6825-55', href:'https://pullman.accor.com/fr/hotels/montpellier/1294.html', services:['restaurant','bar','parking','meeting-rooms','gym','wifi','breakfast'] },
      { name:'Pullman Paris Centre - Bercy', loc:'Paris, France', country:'France', img:'HCM_P_7730696', href:'https://pullman.accor.com/fr/hotels/paris/2192.html', services:['restaurant','bar','parking','meeting-rooms','gym','wifi','breakfast'] },
      { name:'Pullman Paris La Défense', loc:'Paris La Défense, France', country:'France', img:'HCM_P_4713972', href:'https://pullman.accor.com/fr/hotels/paris/3013.html', services:['restaurant','bar','parking','meeting-rooms','coworking','gym','wifi','breakfast','pets'] },
      ...
      { name:'Pullman Paris Montparnasse', loc:'Paris, France', country:'France', img:'HCM_P_1448143', href:'https://pullman.accor.com/fr/hotels/paris/8189.html', services:['restaurant','bar','rooftop','parking','meeting-rooms','gym','wifi','breakfast','pets'] },
      { name:'Pullman Toulouse Airport', loc:'Toulouse, France', country:'France', img:'HCM_P_9842792', href:'https://pullman.accor.com/fr/hotels/toulouse/0565.html', services:['restaurant','bar','parking','meeting-rooms','gym','wifi','breakfast','airport-shuttle'] },
      ...
      { name:'Pullman Brussels Centre Midi', loc:'Bruxelles, Belgique', country:'Belgique', img:'HCM_P_9624550', href:'https://pullman.accor.com/fr/hotels/brussels/7431.html', services:['restaurant','bar','parking','meeting-rooms','gym','wifi','breakfast'] },
      ...
      { name:'Pullman Eindhoven Cocagne', loc:'Eindhoven, Pays-Bas', country:'Pays-Bas', img:'aja_p_2109-36', href:'https://pullman.accor.com/fr/hotels/eindhoven/5374.html', services:['restaurant','bar','parking','meeting-rooms','gym','wifi','breakfast'] },
      ...
      { name:'Pullman London St Pancras', loc:'Londres, Royaume-Uni', country:'Royaume-Uni', img:'aja_p_5227-26', href:'https://pullman.accor.com/fr/hotels/london/5309.html', services:['restaurant','bar','meeting-rooms','gym','wifi','breakfast'] },
      ...
      { name:'Pullman Gorni Okol', loc:'Gorni Okol, Bulgarie', country:'Bulgarie', img:'aja_p_6736-09', href:'https://pullman.accor.com/fr/hotels/gorni-okol/B364.html', services:['restaurant','bar','pool','spa','parking','meeting-rooms','gym','wifi','breakfast','garden','pets'] },
    ]},
    { id:'asie', label:'Asie', img:'https://images.unsplash.com/photo-1493780474015-ba834fd0ce2f?w=200&h=200&fit=crop', hotels: [
      ...
      { name:'Pullman Khao Lak Resort', loc:'Phang Nga, Thaïlande', country:'Thaïlande', img:'HCM_P_1554785', href:'https://pullman.accor.com/fr/hotels/phang-nga/B436.html', services:['pool','restaurant','bar','spa','beach','kids-club','gym','wifi','breakfast','garden'] },
      { name:'Pullman Pattaya Hotel G', loc:'Pattaya, Thaïlande', country:'Thaïlande', img:'HCM_P_7523610', href:'https://pullman.accor.com/fr/hotels/pattaya/7540.html', services:['pool','restaurant','bar','spa','beach','gym','meeting-rooms','wifi','breakfast'] },
      { name:'Pullman Phuket Arcadia', loc:'Phuket, Thaïlande', country:'Thaïlande', img:'aja_p_5366-99', href:'https://pullman.accor.com/fr/hotels/phuket/7488.html', services:['pool','restaurant','bar','spa','beach','kids-club','parking','meeting-rooms','gym','wifi','breakfast','airport-shuttle','pets'] },
      { name:'Pullman Phuket Panwa Beach', loc:'Phuket, Thaïlande', country:'Thaïlande', img:'aja_p_5468-90', href:'https://pullman.accor.com/fr/hotels/phuket/A2E5.html', services:['pool','restaurant','bar','spa','beach','kids-club','gym','wifi','breakfast','garden'] },
      { name:'Pullman Bali Legian Beach', loc:'Bali, Indonésie', country:'Indonésie', img:'HCM_P_7887571', href:'https://pullman.accor.com/fr/hotels/legian/6556.html', services:['pool','restaurant','bar','spa','beach','kids-club','gym','meeting-rooms','wifi','breakfast'] },
      { name:'Pullman Bandung Grand Central', loc:'Bandung, Indonésie', country:'Indonésie', img:'aja_p_5545-01', href:'https://pullman.accor.com/fr/hotels/bandung/9109.html', services:['pool','restaurant','bar','spa','parking','meeting-rooms','gym','wifi','breakfast','pets'] },
      { name:'Pullman Ciawi Vimala Hills', loc:'Bogor, Indonésie', country:'Indonésie', img:'9061-1', href:'https://pullman.accor.com/fr/hotels/bogor/9061.html', services:['pool','restaurant','bar','spa','parking','meeting-rooms','gym','wifi','breakfast','garden','golf'] },
      ...
      { name:'Pullman Lombok Merujani', loc:'Lombok, Indonésie', country:'Indonésie', img:'aja_p_6419-71', href:'https://pullman.accor.com/fr/hotels/central-lombok/A1K2.html', services:['pool','restaurant','bar','spa','beach','kids-club','gym','wifi','breakfast','garden'] },
      { name:'Pullman Danang Beach Resort', loc:'Danang, Vietnam', country:'Vietnam', img:'HCM_P_6539226', href:'https://pullman.accor.com/fr/hotels/danang/8838.html', services:['pool','restaurant','bar','spa','beach','kids-club','gym','meeting-rooms','wifi','breakfast'] },
      ...
      { name:'Pullman Phu Quoc Beach Resort', loc:'Phu Quoc, Vietnam', country:'Vietnam', img:'aja_p_5547-83', href:'https://pullman.accor.com/fr/hotels/phu-quoc/A248.html', services:['pool','restaurant','bar','spa','beach','kids-club','gym','wifi','breakfast','garden','pets'] },
      ...
      { name:'Pullman Oceanview Sanya Bay', loc:'Sanya, Chine', country:'Chine', img:'7126-1', href:'https://pullman.accor.com/fr/hotels/sanya/7126.html', services:['pool','restaurant','bar','spa','beach','kids-club','parking','gym','wifi','breakfast'] },
      ...
      { name:'Pullman Guangzhou Baiyun Airport', loc:'Guangzhou, Chine', country:'Chine', img:'aja_p_3825-02', href:'https://pullman.accor.com/fr/hotels/guangzhou/B2W3.html', services:['restaurant','bar','parking','meeting-rooms','gym','wifi','breakfast','airport-shuttle'] },
      ...
      { name:'Pullman Chennai Anna Salai', loc:'Chennai, Inde', country:'Inde', img:'HCM_P_4907674', href:'https://pullman.accor.com/fr/hotels/chennai/C460.html', services:['pool','restaurant','bar','spa','parking','meeting-rooms','gym','wifi','breakfast','pets'] },
      ...
      { name:'Pullman Kuching', loc:'Kuching, Malaisie', country:'Malaisie', img:'HCM_P_7588157', href:'https://pullman.accor.com/fr/hotels/kuching-sarawak/6332.html', services:['pool','restaurant','bar','spa','parking','meeting-rooms','gym','wifi','breakfast'] },
      ...
      { name:'Pullman Singapore Orchard', loc:'Singapour', country:'Singapour', img:'aja_p_6600-45', href:'https://pullman.accor.com/fr/hotels/singapore/B9H8.html', services:['pool','restaurant','bar','spa','gym','meeting-rooms','wifi','breakfast','rooftop'] },
      { name:'Pullman Maldives Maamutaa', loc:'Maldives', country:'Maldives', img:'aja_p_5241-71', href:'https://pullman.accor.com/fr/hotels/maamutaa-island/9924.html', badge:'NOUVEAU', services:['pool','restaurant','bar','spa','beach','kids-club','gym','wifi','breakfast','garden','pets'] },
      { name:'Pullman Luang Prabang', loc:'Luang Prabang, Laos', country:'Laos', img:'aja_p_4935-28', href:'https://pullman.accor.com/fr/hotels/luang-prabang/9112.html', services:['pool','restaurant','bar','spa','gym','wifi','breakfast','garden'] },
      { name:'Pullman Seoul', loc:'Séoul, Corée du Sud', country:'Corée du Sud', img:'aja_p_6049-58', href:'https://pullman.accor.com/fr/hotels/seoul/0966.html', services:['restaurant','bar','spa','parking','meeting-rooms','gym','wifi','breakfast'] },
    ...
    { id:'moyen-orient', label:'Moyen-Orient', img:'https://images.unsplash.com/photo-1512453979798-5ea266f8880c?w=200&h=200&fit=crop', hotels: [
      { name:'Pullman Dubai Creek City Centre', loc:'Dubaï, EAU', country:'EAU', img:'aja_p_2749-07', href:'https://pullman.accor.com/fr/hotels/dubai/2022.html', services:['pool','restaurant','bar','spa','parking','meeting-rooms','gym','wifi','breakfast','kids-club'] },
      ...
      { name:'Pullman Resort Al Marjan Island', loc:'Ras Al Khaimah, EAU', country:'EAU', img:'HCM_P_5994204', href:'https://pullman.accor.com/fr/hotels/ras-al-khaimah/A0D2.html', services:['pool','restaurant','bar','spa','beach','kids-club','parking','meeting-rooms','gym','wifi','breakfast','garden'] },
      ...
      { name:'Pullman ZamZam Madinah', loc:'Médine, Arabie Saoudite', country:'Arabie Saoudite', img:'aja_p_3895-55', href:'https://pullman.accor.com/fr/hotels/al-madinah-al-munawarah/9245.html', services:['restaurant','bar','parking','meeting-rooms','wifi','breakfast'] },
    ]},
    { id:'oceanie', label:'Océanie', img:'https://images.unsplash.com/photo-1523482580672-f109ba8cb9be?w=200&h=200&fit=crop', hotels: [
      ...
      { name:'Pullman Sydney Hyde Park', loc:'Sydney, Australie', country:'Australie', img:'HCM_P_0028770-99', href:'https://pullman.accor.com/fr/hotels/sydney/8763.html', services:['restaurant','bar','parking','meeting-rooms','gym','wifi','breakfast'] },
      ...
      { name:'Pullman Sydney Airport', loc:'Sydney, Australie', country:'Australie', img:'aja_p_4651-21', href:'https://pullman.accor.com/fr/hotels/sydney/9522.html', services:['restaurant','bar','parking','meeting-rooms','gym','wifi','breakfast','airport-shuttle','pets'] },
      ...
      { name:'Pullman Brisbane King George Sq.', loc:'Brisbane, Australie', country:'Australie', img:'HCM_P_0028771-68', href:'https://pullman.accor.com/fr/hotels/brisbane/8784.html', services:['restaurant','bar','pool','parking','meeting-rooms','gym','wifi','breakfast','pets'] },
      ...
      { name:'Pullman Melbourne Albert Park', loc:'Melbourne, Australie', country:'Australie', img:'HCM_P_0028769-2', href:'https://pullman.accor.com/fr/hotels/melbourne/8788.html', services:['restaurant','bar','pool','parking','meeting-rooms','gym','wifi','breakfast','garden','pets'] },
      ...
      { name:'Pullman Sails in the Desert', loc:'Ayers Rock, Australie', country:'Australie', img:'aja_p_2376-55', href:'https://pullman.accor.com/fr/hotels/yulara/8606.html', services:['pool','restaurant','bar','parking','gym','wifi','breakfast','garden'] },
    ...
    { id:'ameriques', label:'Amériques', img:'https://images.unsplash.com/photo-1534351590666-13e3e96b5017?w=200&h=200&fit=crop', hotels: [
      { name:'Pullman São Paulo Vila Olímpia', loc:'São Paulo, Brésil', country:'Brésil', img:'HCM_P_2616072', href:'https://pullman.accor.com/fr/hotels/sao-paulo/8938.html', services:['pool','restaurant','bar','spa','parking','meeting-rooms','gym','wifi','breakfast'] },
      ...
      { name:'Pullman São Paulo Guarulhos Airport', loc:'Guarulhos, Brésil', country:'Brésil', img:'HCM_P_8881295', href:'https://pullman.accor.com/fr/hotels/sao-paulo/8923.html', services:['pool','restaurant','bar','parking','meeting-rooms','gym','wifi','breakfast','airport-shuttle'] },
      ...
      { name:'Pullman Miami Airport', loc:'Miami, États-Unis', country:'États-Unis', img:'aja_p_4248-17', href:'https://pullman.accor.com/fr/hotels/miami/0889.html', services:['pool','restaurant','bar','parking','meeting-rooms','gym','wifi','breakfast','airport-shuttle'] },
    ...
    { id:'afrique', label:'Afrique', img:'https://images.unsplash.com/photo-1547471080-7cc2caa01a7e?w=200&h=200&fit=crop', hotels: [
      ...
      { name:'Pullman Mazagan Royal Golf & Spa', loc:'El Jadida, Maroc', country:'Maroc', img:'aja_p_6645-45', href:'https://pullman.accor.com/fr/hotels/el-jadida/2960.html', services:['pool','restaurant','bar','spa','beach','parking','meeting-rooms','gym','wifi','breakfast','golf','garden','kids-club'] },
