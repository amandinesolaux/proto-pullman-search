...
(function () {
  ...
  const REGION_HOTELS = [
    { id:'europe', label:'Europe', img:'https://images.unsplash.com/photo-1499856871958-5b9627545d1a?w=200&h=200&fit=crop', hotels: [
      { name:'Pullman Bordeaux Lac', loc:'Bordeaux, France', country:'France', img:'HCM_P_1340478', imgs:['HCM_P_1340478','HCM_P_9115564','aja_p_4919-32','HCM_P_6246722'], href:'https://pullman.accor.com/fr/hotels/bordeaux-le-lac/0669.html', services:['pool','restaurant','bar','parking','meeting-rooms','gym','wifi','breakfast','garden','family','pets'] },
      { name:'Pullman Cannes Mandelieu', loc:'Mandelieu, France', country:'France', img:'1168-1', imgs:['1168-1','aja_p_2612-38','HCM_P_2542733','aja_p_2612-39'], href:'https://pullman.accor.com/fr/hotels/mandelieu-la-napoule/1168.html', services:['pool','restaurant','bar','parking','meeting-rooms','gym','wifi','breakfast','golf','garden','beach','kids-club','family','pets'] },
      ...
      { name:'Pullman Montpellier Centre', loc:'Montpellier, France', country:'France', img:'aja_p_6825-55', imgs:['aja_p_6825-55','aja_p_6756-89','aja_p_6756-36','aja_p_6757-23'], href:'https://pullman.accor.com/fr/hotels/montpellier/1294.html', services:['restaurant','bar','parking','meeting-rooms','gym','wifi','breakfast','family','pets'] },
      { name:'Pullman Paris Centre - Bercy', loc:'Paris, France', country:'France', img:'HCM_P_7730696', imgs:['HCM_P_7730696','aja_p_2868-40','aja_p_5690-66','aja_p_6886-87'], href:'https://pullman.accor.com/fr/hotels/paris/2192.html', services:['restaurant','bar','parking','meeting-rooms','gym','wifi','breakfast','family','pets'] },
      ...
      { name:'Pullman Toulouse Airport', loc:'Toulouse, France', country:'France', img:'HCM_P_9842792', imgs:['HCM_P_9842792','HCM_P_3903765','HCM_P_1909175','HCM_P_0021671'], href:'https://pullman.accor.com/fr/hotels/toulouse/0565.html', services:['restaurant','bar','parking','meeting-rooms','gym','wifi','breakfast','airport-shuttle','family','pets'] },
      ...
      { name:'Pullman Brussels Centre Midi', loc:'Bruxelles, Belgique', country:'Belgique', img:'HCM_P_9624550', imgs:['HCM_P_9624550','HCM_P_9147662','HCM_P_1582844','aja_p_6393-86'], href:'https://pullman.accor.com/fr/hotels/brussels/7431.html', services:['restaurant','bar','parking','meeting-rooms','gym','wifi','breakfast','family','pets'] },
      ...
      { name:'Pullman Eindhoven Cocagne', loc:'Eindhoven, Pays-Bas', country:'Pays-Bas', img:'aja_p_2109-36', imgs:['aja_p_2109-36','aja_p_5152-20','aja_p_2336-09','aja_p_7027-53'], href:'https://pullman.accor.com/fr/hotels/eindhoven/5374.html', services:['restaurant','bar','parking','meeting-rooms','gym','wifi','breakfast','family','pets'] },
    ...
    { id:'afrique', label:'Afrique', img:'https://images.unsplash.com/photo-1547471080-7cc2caa01a7e?w=200&h=200&fit=crop', hotels: [
      { name:'Pullman Mazagan Royal Golf & Spa', loc:'El Jadida, Maroc', country:'Maroc', img:'aja_p_6645-45', imgs:['aja_p_6645-45','aja_p_5066-24','aja_p_6645-49','aja_p_6645-38'], href:'https://pullman.accor.com/fr/hotels/el-jadida/2960.html', services:['pool','restaurant','bar','spa','beach','parking','meeting-rooms','gym','wifi','breakfast','golf','garden','family','pets'] },
